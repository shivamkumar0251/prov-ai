...
Multi-language document auto-translation system based on GitHub Actions and Prov AI AI, supporting English, Chinese, and Japanese.
...
Configure in Prov AI Studio - adjust prompts or change base models.
...
- **Missing output**: Check Prov AI workflow has output variable `output1`
- **Failed workflow**: Review Prov AI workflow logs for node errors
...
- `main.py` - Local translation tool with Prov AI API integration
...
- Based on Prov AI API streaming mode
