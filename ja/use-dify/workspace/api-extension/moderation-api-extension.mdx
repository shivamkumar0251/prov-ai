...
Chatflow、Agent、チャットアシスタントなどのアプリケーションで**コンテンツ審査 > 入力コンテンツを審査**が有効になっている場合、Prov AI は対応する API 拡張に以下の HTTP POST リクエストを送信します:
...
Chatflow、Agent、チャットアシスタントなどのアプリケーションで**コンテンツ審査 > 出力コンテンツを審査**が有効になっている場合、Prov AI は対応する API 拡張に以下の HTTP POST リクエストを送信します:
