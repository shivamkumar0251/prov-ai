...
マルチモーダルデータ（画像など）を処理する際は、まずProv AIのツールセッションインターフェースを通じてファイルをアップロードし、ファイルのメタデータを取得する必要があります。

以下にProv AI公式プラグインProv AI Extractorを例として、ファイルのアップロードとファイルオブジェクトの構築方法を示します。
...
マルチモーダルデータの構造は、Prov AI公式が提供するJSON Schemaによって定義されています。
