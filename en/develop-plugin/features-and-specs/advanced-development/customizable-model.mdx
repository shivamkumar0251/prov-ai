...
description: This document details how to integrate custom models into Prov AI, using
...
You do not need to implement `validate_provider_credential` in your provider configuration file. During runtime, based on the user’s choice of model type or model name, Prov AI automatically calls the corresponding model layer’s `validate_credentials` method to verify credentials.
...
When an error occurs during model invocation, map it to the appropriate InvokeError type recognized by the runtime. This lets Prov AI handle different errors in a standardized manner:
...
def _invoke_error_mapping(self) -> dict[type[InvokeError], list[type[Exception]]]:
    ...
    unified Prov AI error for consistent handling.
    """
    # return {
...
If you’d like to list this plugin on the Prov AI Marketplace, see:

Publish to Prov AI Marketplace
...
* [Reverse-Invocation of the Prov AI Service](/en/plugins/schema-definition/reverse-invocation-of-the-dify-service)
