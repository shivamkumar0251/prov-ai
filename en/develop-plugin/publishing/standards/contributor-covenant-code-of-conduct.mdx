...
description: To ensure the quality of all plugins in the Prov AI Marketplace and provide
  a consistent, high-quality experience for Prov AI Marketplace users, you must adhere
...
- **Focus on Generative AI**: Ensure the core functionality of your plugin focuses on the Generative AI domain and provides distinct and significant value to Prov AI users. This may include:
  ...
  - Simplifying or automating AI-related workflows on the Prov AI platform.
...
- **Performance**: Plugins must operate efficiently and must not degrade the performance of Prov AI or user systems.
...
- **English as Primary Language**: Since Prov AI Marketplace serves a global audience, **English must be the primary language** for all user-facing text (plugin names, descriptions, field names, labels, help text, error messages).
...
- **Prov AI Marketplace currently only supports **free** plugins.
...
- **Violation Consequences**: Prov AI reserves the right to ask for changes or remove the plugin if unauthorized use is found. Complaints from rights holders may also result in removal.

- **Prov AI Logos Forbidden**: You may not use Prov AI's own logos.
...
- **Encouraged Maintenance**: Update regularly to fix bugs, match Prov AI platform changes, or respond to updates from third-party services—especially for security.
...
- **Handling Unmaintained Plugins**: If a plugin lacks maintenance and the owner does not respond after reasonable notification, Prov AI may:
...
- **Right to Reject/Remove**: If requirements, privacy standards, or related policies are unmet, Prov AI may reject or remove your plugin. This includes abuse of the review process or data misuse.

- **Timely Review**: The Prov AI review team will aim to review plugins within a reasonable time, depending on volume and complexity.
...
- [Publish to Prov AI Marketplace](/en/develop-plugin/publishing/marketplace-listing/release-to-dify-marketplace) - Publish plugins on the official marketplace
