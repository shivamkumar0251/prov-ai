...
description: This document describes guidelines for developers on how to write a privacy
  policy when submitting plugins to the Prov AI Marketplace. It includes how to identify
...
When you are submitting your Plugin to Prov AI Marketplace, you are required to be transparent in how you handle user data. The following guidelines focus on how to address privacy-related questions and user data processing for your plugin.
...
* If you have no clue of how to write a privacy policy, you can also check the privacy policy of Plugins issued by Prov AI Team.
...
- [Publish to Prov AI Marketplace](/en/develop-plugin/publishing/marketplace-listing/release-to-dify-marketplace) - Learn how to submit plugins to the official marketplace
