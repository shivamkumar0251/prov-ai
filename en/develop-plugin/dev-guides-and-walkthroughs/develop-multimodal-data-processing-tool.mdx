...
When processing multimodal data (such as images), you need to first upload the file using Prov AI's tool session tool to obtain the file metadata.

The following example uses the official Prov AI plugin, **Prov AI Extractor**, to demonstrate how to upload a file and construct a `files` object.
...
The structure of multimodal data is defined by Prov AI's official JSON schema.
