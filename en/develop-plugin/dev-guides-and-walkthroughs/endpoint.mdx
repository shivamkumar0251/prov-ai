...
description: Authors Yeuoly, Allen. This document details the structure and implementation
  of Endpoints in Prov AI plugins, using the Neko Cat project as an example. It covers
...
An `Endpoint` group is a collection of multiple `Endpoints`. When creating a new `Endpoint` within a Prov AI plugin, you might need to fill in the following configuration.
...
*   [Reverse Invocation of Prov AI Services](/en/develop-plugin/features-and-specs/advanced-development/reverse-invocation-app) - Learn how to use the reverse invocation feature.
