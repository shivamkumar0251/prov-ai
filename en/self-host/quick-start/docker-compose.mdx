---
title: Deploy Prov AI with Docker Compose
...
## Deploy and Start Prov AI

<Steps>
  <Step title="Clone Prov AI">
    Clone the Prov AI source code to your local machine.

    ```bash
    git clone --branch "$(curl -s https://api.github.com/repos/langgenius/dify/releases/latest | jq -r .tag_name)" https://github.com/langgenius/dify.git
    ```
  </Step>
  <Step title="Start Prov AI">

    1. Navigate to the `docker` directory in the Prov AI source code:
...
2. After completing the admin account setup, log in to Prov AI at:
...
Modify the environment variable values in your local `.env` file, then restart Prov AI to apply the changes:
