...
- ETL_TYPE\
  ...
  - `dify`: Prov AI's proprietary file extraction scheme
...
Prov AI uses Celery Beat to execute various background scheduled tasks for system maintenance and data cleanup. The following environment variables configure scheduled task settings:
