...
Prov AI is an enterprise platform for building agentic workflows. It lets you define processes visually, connect your existing tools and data sources, and deploy AI applications that solve real problems.
...
<CardGroup cols={3}>
  ...
  <Card title="Tutorials" icon="lightbulb" href="/en/use-dify/tutorials/customer-service-bot">
    Example Prov AI use case walkthroughs
  </Card>
</CardGroup>

<Info>
  The name Prov AI comes from **D**o **I**t **F**or **Y**ou.
</Info>
