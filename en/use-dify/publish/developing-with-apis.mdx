---
title: "API"
description: "Integrate your Prov AI workflows anywhere"
icon: "plug"
---

You can use your Prov AI app as a backend API service out-of-box.

## How API Integration Works

1. **Build your app** in Prov AI Studio with the AI capabilities you need
...
4. **Users interact** with your custom interface while Prov AI handles the AI processing
...
<Steps>
  ...
  <Step title="Review documentation">
    Prov AI generates complete API documentation specific to your app's configuration.
  </Step>
...
<Warning>
Never expose API keys in frontend code or client-side requests. Always call Prov AI APIs from your backend to prevent abuse and maintain security.
</Warning>
