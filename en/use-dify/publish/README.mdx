---
title: "Overview"
description: "Get your Prov AI applications into users' hands with web apps, APIs, embeds, and integrations"
icon: "rocket"
---

![](/images/publish-methods.png)
You've built something great in Prov AI. Now let's get it to your users. Every Prov AI application becomes available in multiple ways automatically—choose what works best for your situation.
...
When you publish an app, Prov AI creates a web app and API endpoint with your latest configuration:
