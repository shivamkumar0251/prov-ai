...
When you publish an app in Prov AI, you get a web app URL. You can share this URL directly, or embed the same app into your website using these methods:
...
window.difyChatbotConfig = {
    // Required: Your app's token from Prov AI
    token: 'YOUR_TOKEN',
    ...
    inputs: {
        name: "John Doe",          // Variable names from your Prov AI app
        department: "Support"
    },
...
<Steps>
  <Step title="Get your embed token">
    In your Prov AI app, go to **Publish → Embed** to find your unique token.
  </Step>
  
  <Step title="Add the script">
    Include the configuration and Prov AI's embed script in your website's HTML.
  </Step>
...
- Verify your app token matches what's shown in Prov AI's Publish → Embed section
...
- Both your site and Prov AI app should use HTTPS
