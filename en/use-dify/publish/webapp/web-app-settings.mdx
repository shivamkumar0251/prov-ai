...
Web app settings control how your published applications look and behave for end users. Every Prov AI application automatically generates a web interface that adapts to different devices and screen sizes.
...
**Prov AI Community:** Web apps are public by default—anyone with the URL can access them. This works great for demos, public tools, and customer-facing applications.
