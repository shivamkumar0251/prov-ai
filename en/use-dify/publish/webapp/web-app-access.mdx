...
Prov AI Enterprise offers four access levels:

![](https://assets-docs.dify.ai/2025/06/323f40cbf4d0091bc84724fd0bee529c.png)

### All Members Within Platform

Any member of your Prov AI Enterprise workspace can access the app. Users must authenticate with their workspace credentials—password, verification code, or SSO.

Members can access the app through the direct URL or the workspace Explorer page.

<Warning>
If you upgraded from Prov AI Enterprise v2.7.x or earlier with Web App SSO enabled, your apps automatically switched to **Authenticated External Users** permission during the v2.8.x upgrade.
</Warning>
...
Users outside your Prov AI Enterprise workspace can access the app through SSO authentication. Admins manage external users through third-party identity providers, keeping them separate from internal workspace data.

<CardGroup cols={3}>
  <Card title="Large Enterprises" icon="building">
    IT builds apps, other departments use them without joining Prov AI
  </Card>
...
<Info>
If this option is disabled, ask your Prov AI administrator to configure Web App External User Authentication.
</Info>
