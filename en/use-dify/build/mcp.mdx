...
Connect external tools from [MCP servers](https://modelcontextprotocol.io/introduction) to your Prov AI apps. Instead of just built-in tools, you can use tools from the growing [MCP ecosystem](https://mcpservers.org/).

<Note>
  This covers using MCP tools in Prov AI. To publish Prov AI apps as MCP servers, see [here](/en/use-dify/publish/publish-mcp).
</Note>
...
**Name & Icon**: Call it something useful. Prov AI tries to grab icons automatically.
