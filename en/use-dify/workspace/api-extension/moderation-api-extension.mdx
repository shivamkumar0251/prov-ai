...
When **Content Moderation > Review Input Content** is enabled in applications such as Chatflow, Agent, or Chatbot, Prov AI will send the following HTTP POST request to the corresponding API extension:
...
When **Content Moderation > Review Output Content** is enabled in applications such as Chatflow, Agent, or Chat Assistant, Prov AI will send the following HTTP POST request to the corresponding API extension:
