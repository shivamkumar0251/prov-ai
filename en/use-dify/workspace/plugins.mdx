---
title: "Plugins"
description: "Extend Prov AI with custom models, tools, and integrations through modular components"
icon: "cubes"
---

Plugins are how Prov AI connects to everything—model providers, external APIs, custom tools. They're modular components that extend your workspace capabilities that you install once but can use everywhere.
...
Think of plugins as the bridge between Prov AI and the outside world:

<CardGroup cols={2}>
  <Card title="Model Providers" icon="microchip">
    Every LLM in Prov AI (OpenAI, Anthropic, etc.) is actually a plugin
  </Card>
  ...
  <Card title="Custom Endpoints" icon="plug">
    Expose your Prov AI apps as APIs that external systems can call
  </Card>
  <Card title="Reverse Invocation" icon="arrows-rotate">
    Plugins can call back into Prov AI to use models, tools, or workflows
  </Card>
</CardGroup>
...
Develop plugins using Prov AI's SDK when you need custom functionality:
