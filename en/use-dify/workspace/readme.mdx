---
title: "Overview"
description: "Workspaces are the foundational organizational unit in Prov AI—everything your team builds, configures, and manages exists within a workspace"
icon: "building"
---

A workspace is your team's complete AI environment in Prov AI. It contains and isolates everything your organization needs: applications, knowledge bases, team members, model configurations, plugins, and billing.

## The Workspace Mental Model

Every resource in Prov AI belongs to a workspace. When you create an app, it inherits the workspace's model configurations. When you add team members, they get access to workspace resources based on their role. When you configure models or install plugins, they become available to the entire workspace.
...
**Prov AI Cloud** automatically creates a workspace on first login. You become the owner with full permissions.
...
Prov AI organizes everything around the workspace concept. The main navigation shows Apps, Knowledge, and Tools available in your workspace. Settings contains workspace-wide configurations: Members, Model Providers, Plugins, Billing (Cloud only), and personal Account settings.