...
Managing your apps well is crucial for productive AI development. Prov AI provides comprehensive tools to organize, share, and maintain your applications throughout their lifecycle.
...
<CardGroup cols={2}>
  ...
  <Card title="Import & Export" icon="arrows-exchange">
    Share apps between workspaces using Prov AI's DSL format
  </Card>
...
Prov AI's DSL (Domain Specific Language) format lets you share apps between workspaces and teams:
...
<Info>
Prov AI DSL is the AI application engineering standard (v0.6+) that captures complete app configurations in YAML format.
</Info>
