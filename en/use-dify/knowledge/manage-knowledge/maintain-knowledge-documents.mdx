...
| Action   | Description          |
|:-------- |:---------------------|
| Add     | Add one or batch add multiple new chunks. <br/><br/>For documents chunked with Parent-child mode, both new parent and child chunks can be added. <Info>*Add chunks* is a paid feature on Prov AI Cloud. [Upgrade to Professional or Team](https://dify.ai/pricing) to use it.</Info>|
