...
In this article, you will learn how to develop an AI image generation app using Prov AI.

![](https://assets-docs.dify.ai/dify-enterprise-mintlify/en/workshop/basic/05ff829cf382e82c9ece2676032d2383.png)

## You Will Learn

* Methods for building an Agent using Prov AI
...
Next, you need to fill in the key in [Prov AI - Tools - Stability](https://cloud.dify.ai/tools) by following these steps:
...
To optimize interaction, we need an LLM to concretize user instructions, i.e., to write prompts for generating images. Next, we will configure model providers in Prov AI following these steps.

The Free version of Prov AI provides 200 free OpenAI message credits.
...
Back to **Prov AI - Model Providers**, select **groqcloud**, and click **Setup**.
...
Back to **Prov AI - Studio**, select **Create from Blank**.
