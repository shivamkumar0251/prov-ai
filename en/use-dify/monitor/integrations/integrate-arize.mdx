...
#### 3. Integrating Arize with Prov AI

Configure Arize in the Prov AI application. Open the application you need to monitor, open **Monitoring** in the side menu, and select **Tracing app performance** on the page.
