...
Langfuse is an enterprise LLM engineering platform that helps teams collaborate on debugging, analyzing, and iterating their applications.
...
2. Create a project in Langfuse. After logging in, click **New** on the homepage to create your own project. The **project** will be used to associate with **applications** in Prov AI for data monitoring.
...
4. Configure Langfuse in Prov AI. Open the application you need to monitor, open **Monitoring** in the side menu, and select **Tracing app performance** on the page.
...
After configuration, debugging or production data of the application in Prov AI can be viewed in Langfuse.
