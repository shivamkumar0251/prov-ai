...
enterprise & OpenTelemetry-based observability, evaluation, prompt engineering and experimentation platform for your LLM workflows and agents.
...
#### 3. Integrating Phoenix with Prov AI

Configure Phoenix in the Prov AI application. Open the application you need to monitor, open **Monitoring** in the side menu, and select **Tracing app performance** on the page.
...
#### 4. Integrating Phoenix Cloud with Prov AI
