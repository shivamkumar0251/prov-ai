...
<Tabs>
    ...
    On Prov AI Cloud, many popular trigger plugins are pre-configured with default OAuth clients so you can authorize Prov AI with a single click. 
    ...
    For self-hosted deployments, only the custom OAuth client option is available, meaning that you need to create the OAuth application yourself in the external system.
        ...
        <Tabs>
            <Tab title="Default OAuth Client">
                ...
                2. On the external system's authorization page that pops up, click **Next** to grant Prov AI access.
