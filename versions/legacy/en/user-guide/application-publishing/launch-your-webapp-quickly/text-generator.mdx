...
![](/images/assets/text-generator.png)
...
![](/images/assets/text-generator-batch.png)

#### Step 2 Download the template and fill in the content

Click the **"Download the template here"** button to obtain the template file. Edit the file and fill in the required content, then save it as a `.csv` file. Finally, upload the completed file back to Prov AI.

![](/images/assets/text-generator-batch-download.png)

#### Step 3 Upload the file and run

![](/images/assets/batch-run.png)
...
![](/images/assets/text-generator-saved.png)
...
![](/images/assets/text-generator-more-like-this.png)
