...
Prov AI provides three access permission options. You can choose the appropriate permission according to your application scenario:
...
> If WebApp SSO settings have already been enabled in an older version of Prov AI EE, after upgrading to the new version, the current web app's access permission scope will be set to "Only members within the enterprise".
