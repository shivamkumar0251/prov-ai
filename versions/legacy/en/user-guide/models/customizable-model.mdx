...
*   Invocation Error Mapping Table
    ...
    When a model invocation error occurs, it needs to be mapped to the Runtime-specified `InvokeError` type to facilitate Prov AI's different subsequent processing for different errors.
