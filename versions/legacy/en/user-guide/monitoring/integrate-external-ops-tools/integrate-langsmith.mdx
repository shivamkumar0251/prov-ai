...
Create a project in LangSmith. After logging in, click **New Project** on the homepage to create your own project. The **project** will be used to associate with **applications** in Prov AI for data monitoring.
...
#### 4. Integrating LangSmith with Prov AI

Configure LangSmith in the Prov AI application. Open the application you need to monitor, open **Monitoring** in the side menu, and select **Tracing app performance** on the page.
...
Once configured, the debug or production data from applications within Prov AI can be monitored in LangSmith.

![Debugging Applications in Prov AI](https://assets-docs.dify.ai/dify-enterprise-mintlify/en/guides/monitoring/integrate-external-ops-tools/a1370fdbb79257cba31a565ac6764802.png)

When you switch to LangSmith, you can view detailed operation logs of Prov AI applications in the dashboard.
...
Detailed LLM operation logs through LangSmith will help you optimize the performance of your Prov AI application.
