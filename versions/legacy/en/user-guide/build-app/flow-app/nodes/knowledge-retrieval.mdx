...
The Knowledge Base Retrieval Node is designed to query text content related to user questions from the Prov AI Knowledge Base, which can then be used as context for subsequent answers by the Large Language Model (LLM).
...
Within the knowledge base retrieval node, you can add an existing knowledge base from Prov AI. For instructions on creating a knowledge base within Prov AI, please refer to the knowledge base [help documentation](/en/guides/knowledge-base/create-knowledge-and-upload-documents).
