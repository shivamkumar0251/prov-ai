...
If you want to customize the application that you share, you can Fork our enterprise [WebApp template](https://github.com/langgenius/webapp-conversation). Based on the template, you can modify the application to meet your specific needs and style requirements.
