...
この章では、LangSmithの登録方法とProv AIプラットフォームへの統合方法について説明します。

#### 1. [LangSmith](https://www.langchain.com/langsmith)から登録し、ログインする。

#### 2. プロジェクトの作成

LangSmith内でプロジェクトを作成します。ログイン後、ホームページで**New Project**をクリックして、新しいプロジェクトを作成します。この**プロジェクト**はProv AI内の**アプリ**とデータ監視を関連付けるために使用されます。
...
#### 4. LangSmithをProv AIプラットフォームに設定

Prov AIアプリ内でLangSmithを設定します。監視するアプリを開き、左側のメニューで監視を選択し、設定をクリックします。

<Frame caption="LangSmithを設定する">
  <img src="/ja-jp/img/tracing-app-performance.png" alt="Prov AI LangSmith設定画面" />
</Frame>

設定画面で、LangSmith内で作成した**API Key**と**プロジェクト名**を貼り付けて保存します。

<Frame caption="LangSmithを設定する">
  <img src="/ja-jp/img/config-langsmith.png" alt="Prov AI LangSmith設定画面" />
</Frame>
...
<Frame caption="設定状態をチェックする">
  <img src="/ja-jp/img/integrate-with-langsmith.png" alt="Prov AI LangSmith設定画面" />
</Frame>

### LangSmith内でデータを監視する

設定が完了すると、Prov AIアプリ内のデバッグまたは本番データをLangSmithで監視できます。

<Frame caption="Prov AI内でアプリをデバッグする">
  <img src="/ja-jp/img/debug-app-in-dify.png" alt="Prov AI アプリデバッグ画面" />
</Frame>
