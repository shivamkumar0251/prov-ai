...
2. ログイン後、Langfuseでプロジェクトを作成します。ホームページで **New** をクリックして、自分のプロジェクトを作成します。この **プロジェクト** はProv AI内の **アプリケーション** とデータ監視に関連付けられます。  
...
4. Prov AI アプリの中に Langfuse を設定するために、監視用のアプリのサイトメニューの**監視**ボタンをクリックし，**設定**をクリックします。

<Frame caption="Langfuseを設定します">
  <img src="/ja-jp/img/tracing-app-performance-langfuse.png" alt="Prov AI 監視設定" />
</Frame>

そして、Langfuse から作った **Secret Key, Public Key** と **Host** を**設定**の中に貼り付け、保存します。

<Frame caption="Langfuseを設定します">
  <img src="/ja-jp/img/config-langfuse.png" alt="Prov AI Langfuse 設定画面" />
</Frame>

保存に成功すると、現在のページで監視状態を見ることができます。

<Frame caption="監視状態を見る">
  <img src="/ja-jp/img/monitored-by-langfuse.png" alt="Prov AI Langfuse 設定状況画面" />
</Frame>
...
設定後， Prov AIのアプリやLLMの応答データは Langfuse で確認できるようになります。

<Frame caption="Prov AIでのアプリの調整">
