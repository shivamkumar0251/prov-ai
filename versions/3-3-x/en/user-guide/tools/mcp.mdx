...
Use [tools](https://modelcontextprotocol.io/docs/concepts/tools) provided by external [MCP](https://modelcontextprotocol.io/introduction) servers directly in your Prov AI agents and workflow applications. Instead of being limited to existing Prov AI plugins, you can tap into a growing [ecosystem](https://mcpservers.org/) of MCP servers that provide specialized capabilities.

<Note>
  This article shows how to use MCP tools within Prov AI. If you're looking to publish an Prov AI application as an MCP server, check [here](/versions/3-3-x/en-us/user-guide/application-publishing/publish-mcp).
</Note>
...
Navigate to **Tools** → **MCP** in your Prov AI workspace. This is where you manage all external MCP servers that provide tools for your applications.

![6cef1436fcc13a65ccedb54bcf5ab77eb87b8faba1098a85951839fb1907f2d2.png](https://mintlify.s3.us-west-1.amazonaws.com/dify-6c0370d8/images/6cef1436fcc13a65ccedb54bcf5ab77eb87b8faba1098a85951839fb1907f2d2.png)

## Adding an MCP Server

<img
  src="https://mintlify.s3.us-west-1.amazonaws.com/dify-6c0370d8/images/b5429131836c1caae84f4ce8b3b806221e39636723644961ce2f2a97d5421f16.png"
...
**Name & Icon**: Give it a name that describes what tools it provides. Prov AI auto-fetches icons when ever it can from the server domain, or you can choose your own.

**Server Identifier**: A unique ID (lowercase, numbers, underscores, hyphens, max 24 characters) that Prov AI uses to track this server.
...
After adding a server, Prov AI automatically:
...
A server card is added once Prov AI successfully retrieves at least one usable tool:

![fcef5ecad1deca82a1d8988c4bcb7cec745a0cd47945ff05fca588502cfaafbc.png](https://mintlify.s3.us-west-1.amazonaws.com/dify-6c0370d8/images/fcef5ecad1deca82a1d8988c4bcb7cec745a0cd47945ff05fca588502cfaafbc.png)
...
<img
  src="https://mintlify.s3.us-west-1.amazonaws.com/dify-6c0370d8/images/7b526a64ff34b10a357511b2cd3e42f251a6786210eac71c58ca7bfccdf63f0c.png"
...
<img
  src="https://mintlify.s3.us-west-1.amazonaws.com/dify-6c0370d8/images/CleanShot2025-07-07at07.28.04@2x.png"
...
<img
  src="https://mintlify.s3.us-west-1.amazonaws.com/dify-6c0370d8/images/CleanShot2025-07-07at07.41.33@2x.png"
...
When you export Prov AI applications that use MCP tools:
