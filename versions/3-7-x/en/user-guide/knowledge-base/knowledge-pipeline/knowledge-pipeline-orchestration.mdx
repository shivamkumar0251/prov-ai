---
title: "Step 2: Orchestrate Knowledge Pipeline"
---
...
In a knowledge base, you can choose single or multiple data sources. Currently, Prov AI supports 4 types of data sources: **file upload, online drive, online documents, and web crawler**.

Visit the [Prov AI Marketplace](https://marketplace.dify.ai) for more data sources.
...
An enterprise web parsing tool providing simple and easy-to-use API services, suitable for fast crawling and processing web content.
...
An enterprise web parsing tool that provides more refined crawling control options and API services. It supports deep crawling of complex website structures, recommended for batch processing and precise control.
...
Connect your online cloud storage services (e.g., Google Drive, Dropbox, OneDrive) and let Prov AI automatically retrieve your files. Simply select and import the documents you need for processing, without manually downloading and re-uploading files.
...
You can choose Prov AI's Doc Extractor to process files, or select tools based on your needs from Marketplace which offers Prov AI Extractor and third-party tools such as Unstructured.
...
If no images are extracted by the selected processor, Prov AI will automatically extract JPG, JPEG, PNG, and GIF images under 2 MB that are referenced via accessible URLs using the following Markdown syntax:
...
Prov AI Extractor is a built-in document parser presented by Prov AI. It supports multiple common file formats and is specially optimized for Doc files. It can extract and store images from documents and return image URLs.

![Prov AI Extractor](/images/knowledge-base/knowledge-pipeline-orchestration-5.png)
...
<Tip>
  Explore more tools in the [Prov AI Marketplace](https://marketplace.dify.ai).
</Tip>
...
Different documents require different chunking strategies. A product manual works best when split by product features, while research papers should be divided by logical sections. Prov AI offers 3 types of chunkers for various document types and use cases.
...
- **Knowledge Description**\
  Provide a brief description of your knowledge base. This helps the AI better understand and retrieve your data. If left empty, Prov AI will apply the default retrieval strategy.
- **Permissions**\
