...
1. **Select Data Source**  
   Choose from the data source types configured in your pipeline. Prov AI currently supports 4 types of data sources: File Upload (pdf, docx, etc.), Online Drive (Google Drive, OneDrive, etc.), Online Doc (Notion), and Web Crawler (Jina Reader, Firecrawl). 
   Please visit [Prov AI Marketplace](https://marketplace.dify.ai/) to install additional data sources.
