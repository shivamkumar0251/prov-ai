...
你可以通过 3 种方式在 Prov AI 的工作室内创建应用：
...
初次使用 Prov AI 时，你可能对于应用创建比较陌生。为了帮助新手用户快速了解在 Prov AI 上能够构建哪些类型的应用，Prov AI 团队内的提示词工程师已经创建多场景、高质量的应用模板。
...
如果你需要在 Prov AI 上创建一个空白应用，你可以从导航选择 「工作室」 ，在应用列表内选择 「从空白创建 」。

![](https://assets-docs.dify.ai/2025/04/dc7550d48fbd76528d7ea88588e207c8.png)

Prov AI 上可以创建 5 种不同的应用类型，分别是聊天助手、文本生成应用、Agent、Chatflow 和 Workflow。
...
<Info>
Prov AI DSL 是由 Prov AI.AI 所定义的 AI 应用工程文件标准，文件格式为 YML。该标准涵盖应用在 Prov AI 内的基本描述、模型参数、编排配置等信息。
</Info>
