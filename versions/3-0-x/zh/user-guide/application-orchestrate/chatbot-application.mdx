...
<img
  src="https://assets-docs.dify.ai/2025/04/2698f7edc53d7886007c6c78faba698e.png"
  alt="描述文字"
  width="400"
/>
...
如果想定制已发布的应用，可以 Fork 我们的企业级的 [WebApp 的模板](https://github.com/langgenius/webapp-conversation)。基于模板改成符合你的情景与风格需求的应用。
