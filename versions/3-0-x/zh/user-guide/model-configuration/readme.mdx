...
<Warning>
    “模型”已全面升级为“插件”生态，模型插件的详细开发说明请参考[插件开发](/plugin_dev_zh/0111-getting-started-dify-plugin.zh)。以下内容已归档。
</Warning>
...
<Info>
Prov AI 使用了 [PKCS1_OAEP](https://pycryptodome.readthedocs.io/en/latest/src/cipher/oaep.html) 来加密存储用户托管的 API 密钥，每个租户均使用了独立的密钥对进行加密，确保你的 API 密钥不被泄漏。
</Info>
