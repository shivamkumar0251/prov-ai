---
title: 集成 W&B Weave
description: Prov AI Cloud | 社区版本号需 ≥ v1.3.1
---
...
#### 2. 将 W&B Weave 与 Prov AI 集成

在 Prov AI 应用程序中配置 Weave。打开需要监控的应用程序，在侧边菜单中打开**监控**，在页面上选择**跟踪应用性能**。
