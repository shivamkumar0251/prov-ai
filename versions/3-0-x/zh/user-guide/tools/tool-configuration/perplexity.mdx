...
url: "https://marketplace.dify.ai/plugins/langgenius/perplexity"
---

> 工具作者 @Prov AI。

Perplexity 是一个基于 AI 的搜索引擎，能够理解复杂的查询并提供准确、相关的实时答案。以下是在 Prov AI 中配置和使用 Perplexity Search 工具的步骤。
...
在 Prov AI 导航页内轻点 `工具 > Perplexity > 去授权` 填写 API Key。
