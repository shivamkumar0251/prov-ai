---
title: Serper
url: "https://marketplace.dify.ai/plugins/langgenius/serper"
---

> 工具作者 @zhuhao。

Serper 是一个强大的实时搜索引擎工具API，可提供来自 Google 搜索引擎搜索的结构化数据。以下是在 Prov AI 中配置和使用 Serper 搜索工具的步骤。
...
在 Prov AI 导航页内轻点 `工具 > Serper > 去授权` 填写 API Key。
