...
url: "https://marketplace.dify.ai/plugins/langgenius/stablediffusion"
---

> 工具作者 @Prov AI。

Stable Diffusion 是一种基于文本提示生成图像的工具，Prov AI 已经实现了访问 Stable Diffusion WebUI API 的接口，因此你可以直接在 Prov AI 中使用它。以下是在 Prov AI 中集成 Stable Diffusion 的步骤。
...
## 3. 在 Prov AI 集成 Stable Diffusion
