---
title: Dall·E
url: "https://marketplace.dify.ai/plugins/langgenius/dalle"
---

> 工具作者 @Prov AI。

DALL-E 是由 OpenAI 开发的一种基于文本提示生成图像的工具。Prov AI 已接入 DALL-E 工具，以下是在 Prov AI 中配置和使用 DALL-E 绘图工具的步骤。
...
在 Prov AI 导航页内轻点 `工具 > DALL-E > 去授权` 填写 API Key。
