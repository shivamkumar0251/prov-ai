---
title: Bing 搜索
url: "https://marketplace.dify.ai/plugins/langgenius/bing"
---

> 工具作者 @Prov AI。

Bing 搜索工具能够帮助你在使用 LLM 应用的时候，获取联网搜索结果。以下是在 Prov AI 中配置和使用 Bing 搜索工具的步骤。
...
在 Prov AI 导航页内轻点 `工具 > Azure > 去授权` 填写 API Key。
