...
* `parameters` 参数列表
  ...
  * `options` 参数选项
    * 在`llm`模式下，Prov AI 会将所有选项传递给 LLM，LLM 可以根据这些选项进行推理
...
<Frame caption="">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/zh_CN/guides/tools/c99fed3e1bbe5d724810fd6118012071.png" alt="" />
</Frame>
