...
Now you can also directly call the OpenAI Moderation API on Prov AI; you can review either input or output content simply by entering the corresponding "preset reply."
