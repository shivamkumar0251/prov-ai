...
*   Invocation Error Mapping Table
    ...
    When a model invocation error occurs, it needs to be mapped to the `InvokeError` type specified by Runtime, facilitating Prov AI to handle different errors differently.
