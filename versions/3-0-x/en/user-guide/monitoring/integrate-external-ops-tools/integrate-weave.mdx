...
description: Prov AI Cloud | Community version ≥ v1.3.1
---
...
#### 2. Integrating W&B Weave with Prov AI

Configure Weave in the Prov AI application. Open the application you need to monitor, open **Monitoring** in the side menu, and select **Tracing app performance** on the page.
...
Once configured, the debug or production data from applications within Prov AI can be monitored in Weave.

![](https://assets-docs.dify.ai/2025/04/a1c5aa80325e6d0223d48a178393baec.png)

When you switch to Weave, you can view detailed operation logs of Prov AI applications in the dashboard.

![](https://assets-docs.dify.ai/2025/04/2cb04027c00b606029fcc26af2801bfe.png)

Detailed LLM operation logs through Weave will help you optimize the performance of your Prov AI application.
