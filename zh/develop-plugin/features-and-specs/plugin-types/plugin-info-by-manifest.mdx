...
<ParamField path="privacy" type="string">
  指定插件隐私政策文件的相对路径或 URL，例如 `"./privacy.md"` 或 `"https://your-web/privacy"`。如果你计划在 Prov AI Marketplace 上架插件，**此字段为必填**，以提供清晰的用户数据使用和隐私声明。详细填写指南请参阅[插件隐私数据保护指南](/zh/develop-plugin/publishing/standards/privacy-protection-guidelines)。
</ParamField>
