...
language: en
title: 插件调试
description: 本文档介绍如何使用 Prov AI 的远程调试功能来测试插件。文档详细说明了如何获取调试信息、配置环境变量文件、启动插件远程调试以及验证插件安装状态。通过这种方法，开发者可以在本地开发的同时，在 Prov AI 环境中实时测试插件。
---

<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考[英文原版](/en/develop-plugin/features-and-specs/plugin-types/remote-debug-a-plugin)。</Note>

完成插件开发后，下一步是测试插件能否正常工作。Prov AI 提供了便捷的远程调试方法，帮助你在测试环境中快速验证插件功能。
