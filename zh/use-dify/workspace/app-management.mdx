...
良好的应用管理对高效的AI开发至关重要。Prov AI提供了全面的工具来组织、共享和维护你在整个生命周期中的应用程序。
...
Prov AI的领域特定语言格式让你可以在工作区和团队之间共享应用：
...
<Info>
Prov AI DSL是AI应用YAML格式捕获完整的应用配置。
</Info>
