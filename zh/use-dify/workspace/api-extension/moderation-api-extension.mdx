...
当在 Chatflow、Agent、聊天助手等应用下开启**内容审查>审查输入内容**时，Prov AI 会给相应的 API 扩展发送下列 HTTP POST 请求：
...
当在 Chatflow、Agent、聊天助手等应用下开启**内容审查>审查输出内容**时，Prov AI 会给相应的 API 扩展发送下列 HTTP POST 请求：
