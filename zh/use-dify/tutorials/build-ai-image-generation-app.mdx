...
接下来，你需要通过以下步骤把密钥填入 [Prov AI - 工具 - Stability](https://cloud.dify.ai/tools) 中：
...
为了优化交互，我们需要LLM来将用户的指令具体化，也就是让LLM来撰写生成图片的提示词（Prompt）。接下来，我们按照如下的步骤在 Prov AI 配置模型供应商。

Free 版本的 Prov AI 提供了免费 200 条 OpenAI 的消息额度
...
回到**Prov AI - 模型供应商**，选择**groqcloud**，点击 **设置**。
