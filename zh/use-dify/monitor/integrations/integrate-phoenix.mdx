...
企业级且基于OpenTelemetry的可观测性、评估、提示工程和实验平台，适用于你的LLM工作流程和代理。
...
本章节将指引你注册 Phoenix 并将其集成至 Prov AI 平台内。
...
### 3. 集成 Phoenix 与 Prov AI

在 Prov AI 应用程序中配置 Phoenix。打开需要监控的应用程序，在侧边菜单中打开**监控**，并在页面上选择**追踪应用性能**。
...
本章节将指引你注册 Phoenix Cloud 并将其集成至 Prov AI 平台内。
