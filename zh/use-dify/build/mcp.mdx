...
将来自 [MCP 服务器](https://modelcontextprotocol.io/introduction) 的外部工具连接到你的 Prov AI 应用程序。你可以使用不断增长的 [MCP 生态系统](https://mcpservers.org/) 中的工具，而不仅仅是内置工具。

<Note>
  本内容涵盖在 Prov AI 中使用 MCP 工具。要将 Prov AI 应用程序发布为 MCP 服务器，请参阅[这里](/zh/use-dify/publish/publish-mcp)。
</Note>
...
**名称和图标**：给它一个有用的名称。Prov AI 会尝试自动获取图标。
